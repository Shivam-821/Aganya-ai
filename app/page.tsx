      ...
      <section className="container mx-auto px-6 relative pt-12 pb-16">
        <div className="flex flex-col items-center text-center max-w-5xl mx-auto z-10 relative">
          <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-foreground mb-6 animate-in fade-in slide-in-from-bottom-8 duration-700 fill-mode-both delay-100 mt-4">
            ...
            <span className="text-transparent bg-clip-text bg-linear-to-r from-teal-500 to-teal-300">
              Master the Market.
            </span>
          </h1>
        ...
        <div className="relative mt-20 max-w-6xl mx-auto perspective-1000">
            ...
            <div className="p-8 grid grid-cols-12 gap-6 bg-zinc-950/50 backdrop-blur-sm">
              ...
              <div className="col-span-12 md:col-span-3 p-4 rounded-xl bg-zinc-900/30 border border-zinc-800 flex flex-col">
                ...
                <div className="flex-1 space-y-3 mb-4">
                  ...
                  <div className="p-2 rounded-lg bg-teal-500/10 border border-teal-500/20 text-xs text-teal-200">
          ...
          {/* Abstract Glow */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[50%] bg-teal-500/20 blur-[120px] -z-10 rounded-full"></div>
        </div>
      </section>
      ...
      >
        <div className="container mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative group">
            <div className="absolute inset-0 bg-linear-to-tr from-teal-500/20 to-cyan-500/20 rounded-3xl blur-xl opacity-50 group-hover:opacity-75 transition-opacity"></div>
      ...
      <section className="container mx-auto px-6 py-24">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative order-2 md:order-1">
            <div className="absolute -inset-4 bg-linear-to-r from-emerald-500/20 to-teal-500/20 rounded-full blur-2xl opacity-50"></div>
            <div className="relative bg-zinc-950 rounded-2xl border border-zinc-800 p-6 shadow-2xl max-w-md mx-auto md:mx-0">
              ...
              <div className="space-y-4 mb-6">
                <div className="flex gap-3 justify-end">
                  <div className="bg-teal-500 text-white rounded-2xl rounded-tr-sm px-4 py-2 text-sm max-w-[80%]">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-zinc-900 border border-zinc-800 rounded-full px-4 py-3 text-sm text-white focus:outline-none focus:border-teal-500 transition-colors"
                  disabled
                />
                <div className="absolute right-2 top-1/2 -translate-y-1/2 w-8 h-8 bg-teal-500 rounded-full flex items-center justify-center">
      ...
      >
        ...
        <div className="container mx-auto px-6 grid md:grid-cols-3 gap-12">
          <div className="relative flex flex-col items-center text-center group">
            <div className="w-16 h-16 rounded-2xl bg-teal-500/10 text-teal-500 flex items-center justify-center text-2xl font-bold mb-6 group-hover:bg-teal-500 group-hover:text-white transition-all duration-300">
              1
            </div>
            ...
            <div className="hidden md:block absolute top-8 left-1/2 w-full h-0.5 bg-linear-to-r from-transparent via-border to-transparent -z-10 translate-x-1/2"></div>
          </div>
